...
def create_layout():
    return dbc.Container(
        ...
        children=[
            dbc.Row(
                dbc.Col(html.H1("TNEB Utility Dashboard", className='text-center'), className='mt-4 mb-4'),
                justify='center'
            ),
            dbc.Row(
                dbc.Col(
...
def update_line_chart(selected_week, selected_algorithm):
    ...
    fig.update_layout(
        title=dict(text="Weekly Electricity Consumption", x=0.5, font=dict(size=20)),
        xaxis_title="Date",
        yaxis_title="Power Usage (MW)",
        yaxis=dict(range=[y_min, y_max], showgrid=True, gridcolor='darkgray'),  
    ...
    hist_fig_weekend_weekday.update_layout(
        title=dict(text="Average Power Usage - Weekdays vs Weekends", x=0.5),
        yaxis_title="Power Usage (MW)",
        plot_bgcolor='#ffffff',
        paper_bgcolor='rgba(255,255,255,0.9)'  
    )
    ...
    hist_fig_weeks.update_layout(
        title=dict(text="Average Power Usage - Hotter vs Colder Climate", x=0.5),
        yaxis_title="Power Usage (MW)",
        plot_bgcolor='#ffffff',
        paper_bgcolor='rgba(255,255,255,0.9)'  
    )
